...
* Perfect for [Modular Monoliths as often Microservices are often overkill](https://medium.com/design-and-tech-co/modular-monoliths-a-gateway-to-microservices-946f2cbdf382). Microservices allow for independent versioning, release and scaling but increase complexity which is often not needed. Modular Monoliths means each module has independent Presentation, Business and Data like Microservices but are packaged together for Deployment.
